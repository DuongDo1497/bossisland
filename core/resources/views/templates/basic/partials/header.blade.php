...
<div class="header-top bg--section">
  <div class="container">
    <div class="header__top__wrapper">
      <ul>
        <li>
          <span class="name">@lang('Email'): </span><a href="mailto:{{ $header->data_values->email }}"
            class="text--base">{{ __($header->data_values->email) }}</a>
        </li>
        <li>
          <span class="name">@lang('Call Us'): </span><a href="tel:{{ $header->data_values->mobile }}"
            class="text--base">{{ __($header->data_values->mobile) }}</a>
        </li>
      </ul>
    ...
    <div class="header-wrapper">
      ...
      <div class="menu-area">
        ...
        <ul class="menu">
          ...
          <li>
            <a href="{{ route('product.all') }}">@lang('Purchases')</a>
          </li>
          <li>
